...
tamanho = float ( input ('Tamanho da área a ser para pintar: '))
litro = tamanho / 6
...
print ('1 - Latas: ', latas_arredondado, ' / Preço: ', preco_lata, '\n')
print ('2 - Latas: ', galoes_arredondado, '/ Preço: ', preco_galao, '\n')
print ('3 - Latas: ', latas , '/ Galões: ', galoes_resto_arredondado, '/ Preço: ', preco_total_misturado)